 ...
 *     csrf_protection?: bool|array{ // Default: {"enabled":null,"stateless_token_ids":[],"check_header":false,"cookie_name":"csrf-token"}
 ...
 *     },
 *     form?: bool|array{ // Form configuration // Default: {"enabled":true,"csrf_protection":{"enabled":null,"token_id":null,"field_name":"_token","field_attr":{"data-controller":"csrf-protection"}}}
 *         enabled?: bool, // Default: true
 *         csrf_protection?: array{ // Default: {"enabled":null,"token_id":null,"field_name":"_token","field_attr":{"data-controller":"csrf-protection"}}
 *             enabled?: scalar|null, // Default: null
 ...
 *         },
 *     },
 *     http_cache?: bool|array{ // HTTP cache configuration // Default: {"enabled":false,"debug":"%kernel.debug%","private_headers":[],"skip_response_headers":[]}
 *         enabled?: bool, // Default: false
 *         debug?: bool, // Default: "%kernel.debug%"
 *         trace_level?: "none"|"short"|"full",
 *         trace_header?: scalar|null,
 *         default_ttl?: int<min, max>,
 *         private_headers?: list<scalar|null>,
 *         skip_response_headers?: list<scalar|null>,
 *         allow_reload?: bool,
 *         allow_revalidate?: bool,
 *         stale_while_revalidate?: int<min, max>,
 *         stale_if_error?: int<min, max>,
 *         terminate_on_cache_hit?: bool,
 *     },
 *     esi?: bool|array{ // ESI configuration // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     ssi?: bool|array{ // SSI configuration // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     fragments?: bool|array{ // Fragments configuration // Default: {"enabled":false,"hinclude_default_template":null,"path":"/_fragment"}
 *         enabled?: bool, // Default: false
 *         hinclude_default_template?: scalar|null, // Default: null
 *         path?: scalar|null, // Default: "/_fragment"
 *     },
 *     profiler?: bool|array{ // Profiler configuration // Default: {"enabled":false,"collect":true,"collect_parameter":null,"only_exceptions":false,"only_main_requests":false,"dsn":"file:%kernel.cache_dir%/profiler","collect_serializer_data":false}
 *         enabled?: bool, // Default: false
 ...
 *     },
 *     workflows?: bool|array{ // Default: {"enabled":false,"workflows":[]}
 *         enabled?: bool, // Default: false
 *         workflows?: array<string, array{
 *             audit_trail?: bool|array{ // Default: {"enabled":false}
 *                 enabled?: bool, // Default: false
 *             },
 ...
 *                 from?: list<array{
 *                     place: string,
 *                     weight?: int<1, max>, // Default: 1
 *                 }>,
 *                 to?: list<array{
 *                     place: string,
 *                     weight?: int<1, max>, // Default: 1
 *                 }>,
 *                 weight?: int<min, max>, // Default: 1
 *                 metadata?: list<mixed>,
 *             }>,
 *             metadata?: list<mixed>,
 *         }>,
 *     },
 *     router?: bool|array{ // Router configuration // Default: {"enabled":false,"cache_dir":"%kernel.build_dir%","default_uri":null,"http_port":80,"https_port":443,"strict_requirements":true,"utf8":true}
 *         enabled?: bool, // Default: false
 ...
 *     },
 *     session?: bool|array{ // Session configuration // Default: {"enabled":false,"storage_factory_id":"session.storage.factory.native","cookie_secure":"auto","cookie_httponly":true,"cookie_samesite":"lax","metadata_update_threshold":0}
 *         enabled?: bool, // Default: false
 ...
 *         metadata_update_threshold?: int<min, max>, // Seconds to wait between 2 session metadata updates. // Default: 0
 *         sid_length?: int<22, 256>, // Deprecated: Setting the "framework.session.sid_length.sid_length" configuration option is deprecated. It will be removed in version 8.0. No alternative is provided as PHP 8.4 has deprecated the related option.
 *         sid_bits_per_character?: int<4, 6>, // Deprecated: Setting the "framework.session.sid_bits_per_character.sid_bits_per_character" configuration option is deprecated. It will be removed in version 8.0. No alternative is provided as PHP 8.4 has deprecated the related option.
 *     },
 *     request?: bool|array{ // Request configuration // Default: {"enabled":false,"formats":[]}
 *         enabled?: bool, // Default: false
 *         formats?: array<string, string|list<scalar|null>>,
 *     },
 *     assets?: bool|array{ // Assets configuration // Default: {"enabled":true,"strict_mode":false,"version_strategy":null,"version":null,"version_format":"%%s?%%s","json_manifest_path":null,"base_path":"","base_urls":[],"packages":[]}
 *         enabled?: bool, // Default: true
 ...
 *         pseudo_localization?: bool|array{ // Default: {"enabled":false,"accents":true,"expansion_factor":1.0,"brackets":true,"parse_html":false,"localizable_html_attributes":[]}
 *             enabled?: bool, // Default: false
 ...
 *         }>,
 *         globals?: array<string, string|array{
 *             value?: mixed,
 *             message?: string,
 ...
 *         }>,
 *     },
 *     validation?: bool|array{ // Validation configuration // Default: {"enabled":true,"enable_attributes":true,"static_method":["loadValidatorMetadata"],"translation_domain":"validators","email_validation_mode":"html5","mapping":{"paths":[]},"not_compromised_password":{"enabled":true,"endpoint":null},"disable_translation":false,"auto_mapping":[]}
 *         enabled?: bool, // Default: true
 ...
 *         mapping?: array{ // Default: {"paths":[]}
 *             paths?: list<scalar|null>,
 *         },
 *         not_compromised_password?: bool|array{ // Default: {"enabled":true,"endpoint":null}
 ...
 *         auto_mapping?: array<string, array{
 *             services?: list<scalar|null>,
 *         }>,
 *     },
 *     annotations?: bool|array{ // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     serializer?: bool|array{ // Serializer configuration // Default: {"enabled":false,"enable_attributes":true,"mapping":{"paths":[]},"default_context":[],"named_serializers":[]}
 *         enabled?: bool, // Default: false
 *         enable_attributes?: bool, // Default: true
 ...
 *         named_serializers?: array<string, array{
 *             name_converter?: scalar|null,
 *             default_context?: list<mixed>,
 ...
 *         }>,
 *     },
 *     property_access?: bool|array{ // Property access configuration // Default: {"enabled":true,"magic_call":false,"magic_get":true,"magic_set":true,"throw_exception_on_invalid_index":false,"throw_exception_on_invalid_property_path":true}
 *         enabled?: bool, // Default: true
 ...
 *     },
 *     type_info?: bool|array{ // Type info configuration // Default: {"enabled":true,"aliases":[]}
 *         enabled?: bool, // Default: true
 *         aliases?: array<string, scalar|null>,
 *     },
 *     property_info?: bool|array{ // Property info configuration // Default: {"enabled":true}
 *         enabled?: bool, // Default: true
 ...
 *         }>,
 *     },
 *     php_errors?: array{ // PHP errors handling configuration // Default: {"log":true,"throw":true}
 *         log?: mixed, // Use the application logger instead of the PHP logger for logging PHP errors. // Default: true
 *         throw?: bool, // Throw PHP errors as \ErrorException instances. // Default: true
 *     },
 *     exceptions?: array<string, array{
 ...
 *             symfony_serializer?: array{ // Default: {"format":"json","context":[]}
 ...
 *             },
 *         },
 *         transports?: array<string, string|array{
 *             dsn?: scalar|null,
 ...
 *             retry_strategy?: string|array{ // Default: {"service":null,"max_retries":3,"delay":1000,"multiplier":2,"max_delay":0,"jitter":0.1}
 *                 service?: scalar|null, // Service id to override the retry strategy entirely. // Default: null
 *                 max_retries?: int<0, max>, // Default: 3
 *                 delay?: int<0, max>, // Time in ms to delay (or the initial value when multiplier is used). // Default: 1000
 ...
 *                 max_delay?: int<0, max>, // Max time in ms that a retry should ever be delayed (0 = infinite). // Default: 0
 ...
 *         buses?: array<string, array{ // Default: {"default_middleware":{"enabled":true,"allow_no_handlers":false,"allow_no_senders":true},"middleware":[]}
 *             default_middleware?: bool|string|array{ // Default: {"enabled":true,"allow_no_handlers":false,"allow_no_senders":true}
 *                 enabled?: bool, // Default: true
 *                 allow_no_handlers?: bool, // Default: false
 *                 allow_no_senders?: bool, // Default: true
 *             },
 *             middleware?: list<string|array{
 *                 id: scalar|null,
 *                 arguments?: list<mixed>,
 *             }>,
 *         }>,
 *     },
 *     scheduler?: bool|array{ // Scheduler configuration // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     disallow_search_engine_index?: bool, // Enabled by default when debug is enabled. // Default: true
 *     http_client?: bool|array{ // HTTP Client configuration // Default: {"enabled":true,"scoped_clients":[]}
 *         enabled?: bool, // Default: true
 *         max_host_connections?: int<min, max>, // The maximum number of connections to a single host.
 *         default_options?: array{
 *             headers?: array<string, mixed>,
 *             vars?: list<mixed>,
 *             max_redirects?: int<min, max>, // The maximum number of redirects to follow.
 ...
 *             caching?: bool|array{ // Caching configuration. // Default: {"enabled":false,"cache_pool":"cache.http_client","shared":true,"max_ttl":null}
 *                 enabled?: bool, // Default: false
 ...
 *                 max_ttl?: int<0, max>, // The maximum TTL (in seconds) allowed for cached responses. Null means no cap. // Default: null
 *             },
 *             retry_failed?: bool|array{ // Default: {"enabled":false,"retry_strategy":null,"http_codes":[],"max_retries":3,"delay":1000,"multiplier":2,"max_delay":0,"jitter":0.1}
 *                 enabled?: bool, // Default: false
 *                 retry_strategy?: scalar|null, // service id to override the retry strategy. // Default: null
 *                 http_codes?: array<string, array{
 *                     code?: int<min, max>,
 *                     methods?: list<string>,
 *                 }>,
 *                 max_retries?: int<0, max>, // Default: 3
 ...
 *         scoped_clients?: array<string, string|array{
 ...
 *             value?: mixed,
 *         }>,
 *         dkim_signer?: bool|array{ // DKIM signer configuration // Default: {"enabled":false,"key":"","domain":"","select":"","passphrase":"","options":[]}
 *             enabled?: bool, // Default: false
 ...
 *         },
 *         smime_signer?: bool|array{ // S/MIME signer configuration // Default: {"enabled":false,"key":"","certificate":"","passphrase":null,"extra_certificates":null,"sign_options":null}
 *             enabled?: bool, // Default: false
 ...
 *             sign_options?: int<min, max>, // Default: null
 *         },
 *         smime_encrypter?: bool|array{ // S/MIME encrypter configuration // Default: {"enabled":false,"repository":"","cipher":null}
 *             enabled?: bool, // Default: false
 ...
 *             cipher?: int<min, max>, // A set of algorithms used to encrypt the message // Default: null
 *         },
 *     },
 *     secrets?: bool|array{ // Default: {"enabled":true,"vault_directory":"%kernel.project_dir%/config/secrets/%kernel.runtime_environment%","local_dotenv_file":"%kernel.project_dir%/.env.%kernel.runtime_environment%.local","decryption_env_var":"base64:default::SYMFONY_DECRYPTION_SECRET"}
 *         enabled?: bool, // Default: true
 ...
 *     },
 *     notifier?: bool|array{ // Notifier configuration // Default: {"enabled":false,"message_bus":null,"chatter_transports":[],"texter_transports":[],"notification_on_failed_messages":false,"channel_policy":[],"admin_recipients":[]}
 *         enabled?: bool, // Default: false
 *         message_bus?: scalar|null, // The message bus to use. Defaults to the default bus if the Messenger component is installed. // Default: null
 ...
 *         admin_recipients?: list<array{
 *             email?: scalar|null,
 *             phone?: scalar|null, // Default: ""
 *         }>,
 *     },
 *     rate_limiter?: bool|array{ // Rate limiter configuration // Default: {"enabled":false,"limiters":[]}
 *         enabled?: bool, // Default: false
 *         limiters?: array<string, array{
 ...
 *             limit?: int<min, max>, // The maximum allowed hits in a fixed interval or burst.
 ...
 *                 amount?: int<min, max>, // Amount of tokens to add each interval. // Default: 1
 *             },
 *         }>,
 *     },
 *     uid?: bool|array{ // Uid configuration // Default: {"enabled":false,"default_uuid_version":7,"name_based_uuid_version":5,"time_based_uuid_version":7}
 *         enabled?: bool, // Default: false
 ...
 *     },
 *     html_sanitizer?: bool|array{ // HtmlSanitizer configuration // Default: {"enabled":true,"sanitizers":[]}
 *         enabled?: bool, // Default: true
 *         sanitizers?: array<string, array{
 ...
 *             max_input_length?: int<min, max>, // The maximum length allowed for the sanitized input. // Default: 0
 *         }>,
 *     },
 *     webhook?: bool|array{ // Webhook configuration // Default: {"enabled":false,"message_bus":"messenger.default_bus","routing":[]}
 *         enabled?: bool, // Default: false
 ...
 *         }>,
 *     },
 *     remote-event?: bool|array{ // RemoteEvent configuration // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     json_streamer?: bool|array{ // JSON streamer configuration // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 * }
 ...
 *     access_decision_manager?: array{ // Default: {"allow_if_all_abstain":false,"allow_if_equal_granted_denied":true}
 ...
 *     },
 *     password_hashers?: array<string, string|array{
 ...
 *             delete_cookies?: array<string, array{
 ...
 *         types?: array<string, string|array{
 *             class: scalar|null,
 ...
 *             idle_connection_ttl?: int<min, max>, // Default: 600
 ...
 *         controller_resolver?: bool|array{ // Default: {"enabled":true,"auto_mapping":null,"evict_cache":false}
 *             enabled?: bool, // Default: true
 ...
 *         },
 *         entity_managers?: array<string, array{ // Default: {"query_cache_driver":{"type":null},"result_cache_driver":{"type":null},"class_metadata_factory_name":"Doctrine\\ORM\\Mapping\\ClassMetadataFactory","default_repository_class":"Doctrine\\ORM\\EntityRepository","auto_mapping":false,"naming_strategy":"doctrine.orm.naming_strategy.default","quote_strategy":"doctrine.orm.quote_strategy.default","typed_field_mapper":"doctrine.orm.typed_field_mapper.default","entity_listener_resolver":null,"repository_factory":"doctrine.orm.container_repository_factory","schema_ignore_classes":[],"report_fields_where_declared":true,"validate_xml_mapping":false,"hydrators":[],"mappings":[],"filters":[],"identity_generation_preferences":[]}
 *             query_cache_driver?: string|array{ // Default: {"type":null}
 ...
 *                 pool?: scalar|null,
 *             },
 *             result_cache_driver?: string|array{ // Default: {"type":null}
 *                 type?: scalar|null, // Default: null
 *                 id?: scalar|null,
 *                 pool?: scalar|null,
 *             },
 ...
 *                 region_cache_driver?: string|array{ // Default: {"type":null}
 *                     type?: scalar|null, // Default: null
 *                     id?: scalar|null,
 *                     pool?: scalar|null,
 *                 },
 ...
 *                     cache_driver?: string|array{ // Default: {"type":null}
 *                         type?: scalar|null, // Default: null
 *                         id?: scalar|null,
 *                         pool?: scalar|null,
 *                     },
 ...
 *                     name?: scalar|null,
 *                 }>,
 *                 loggers?: array<string, array{
 *                     name?: scalar|null,
 *                     service?: scalar|null,
 *                 }>,
 *             },
 *             hydrators?: array<string, scalar|null>,
 *             mappings?: array<string, bool|string|array{
 ...
 *         process_psr_3_messages?: array{ // Default: {"enabled":null}
 ...
 *         excluded_http_codes?: list<array{
 *             code?: scalar|null,
 ...
 *     date?: array{ // The default format options used by the date filter. // Default: {"format":"F j, Y H:i","interval_format":"%d days","timezone":null}
 ...
 *     },
 *     number_format?: array{ // The default format options for the number_format filter. // Default: {"decimals":0,"decimal_point":".","thousands_separator":","}
 *         decimals?: int<min, max>, // Default: 0
 ...
 *     max_items?: int<-1, max>, // Max number of displayed items past the first level, -1 means no limit. // Default: 2500
 *     min_depth?: int<0, max>, // Minimum tree depth to clone all the items, 1 is default. // Default: 1
 *     max_string_length?: int<-1, max>, // Max length of displayed strings, -1 means no limit. // Default: -1
 ...
 *     toolbar?: bool|array{ // Profiler toolbar configuration // Default: {"enabled":false,"ajax_replace":false}
 *         enabled?: bool, // Default: false
 ...
 * }
 * @psalm-type DamaDoctrineTestConfig = array{ // Default: {"enable_static_connection":true,"enable_static_meta_data_cache":true,"enable_static_query_cache":true,"connection_keys":[]}
 ...
 *     storage?: array{ // Storage to use for migration status metadata. // Default: {"table_storage":{"table_name":null,"version_column_name":null,"version_column_length":null,"executed_at_column_name":null,"execution_time_column_name":null}}
 *         table_storage?: array{ // The default metadata storage, implemented as a table in the database. // Default: {"table_name":null,"version_column_name":null,"version_column_length":null,"executed_at_column_name":null,"execution_time_column_name":null}
 ...
 *     cache?: bool|array{ // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     html?: bool|array{ // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     markdown?: bool|array{ // Default: {"enabled":true}
 *         enabled?: bool, // Default: true
 *     },
 *     intl?: bool|array{ // Default: {"enabled":true}
 *         enabled?: bool, // Default: true
 *     },
 *     cssinliner?: bool|array{ // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     inky?: bool|array{ // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     string?: bool|array{ // Default: {"enabled":false}
 *         enabled?: bool, // Default: false
 *     },
 *     commonmark?: array{
 ...
 *         max_nesting_level?: int<min, max>, // The maximum nesting level for blocks. // Default: 9223372036854775807
 *         slug_normalizer?: array{ // Array of options for configuring how URL-safe slugs are created.
 *             instance?: mixed,
 *             max_length?: int<min, max>, // Default: 255
 *             unique?: mixed,
 *         },
 ...
 *     defaults?: array<string, string|array{
 ...
 * }
 * @psalm-type LiveComponentConfig = array{ // Default: {"secret":"%kernel.secret%"}
 ...
 *     sass_options?: array{ // Default: {"style":"expanded","source_map":true,"embed_source_map":"%kernel.debug%","load_path":[]}
 ...
 *     icon_sets?: array<string, array{ // the icon set prefix (e.g. "acme")
 ...
 *     iconify?: bool|array{ // Configuration for the remote icon service. // Default: {"enabled":true,"on_demand":true,"endpoint":"https://api.iconify.design"}
 *         enabled?: bool, // Default: true
